<div x-data="{
    ...
    <div class="mb-8 flex items-center justify-between">
        <div>
            ...
            <h2 class="mt-2 text-xl font-bold text-gray-900">Create New Role</h2>
        </div>
        ...
        <div class="rounded-xl bg-white shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="p-6 border-b border-gray-200">
                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    <div>
                        <label for="role-name" class="block text-sm font-medium text-gray-700 mb-1.5">Role Name <span class="text-red-500">*</span></label>
                        <input wire:model="name" id="role-name" type="text" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" placeholder="e.g. Lab Technician">
                        @error('name')<p class="mt-1 text-xs text-red-600">{{ $message }}</p>@enderror
                    </div>
                    <div>
                        <label for="role-desc" class="block text-sm font-medium text-gray-700 mb-1.5">Description</label>
                        <input wire:model="description" id="role-desc" type="text" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" placeholder="Brief description of this role">
                    </div>
                </div>
            </div>
